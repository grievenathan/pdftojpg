...
export const metadata = {
  title: "Privacy Policy - PDF To JPG",
  description: "Privacy policy for pdftojpg.co.uk. All PDF conversion happens locally in your browser - your files never leave your device.",
};
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        <h1 className="mb-2 text-3xl font-semibold tracking-tight text-black sm:text-4xl">
          Privacy Policy
        </h1>
        ...
        <div className="space-y-10">
          ...
          <Section title="The short version">
            <p>
              This tool converts your PDF documents to JPG images entirely inside your browser.
              Your files are never uploaded to our servers - they stay on your
              device at all times.
            </p>
          </Section>
          ...
          <Section title="Who we are">
            <p>
              pdftojpg.co.uk is operated by Modern CV Limited.
            </p>
          </Section>

          <Section title="How the conversion works">
            <p>
              All PDF processing runs locally in your web browser. When you
              select or drop a file:
            </p>
            <ul className="mt-3 space-y-2 text-muted">
              <ListItem>The file is read into browser memory only</ListItem>
              <ListItem>The conversion happens on your device - no file data leaves your browser</ListItem>
              <ListItem>The converted JPG images are made available for download directly</ListItem>
            </ul>
          </Section>

          <Section title="Information we may collect">
            <p>
              While your files are never sent to our servers, we may collect
...
function Section({
  ...
  return (
    <section>
      <h2 className="mb-3 text-base font-semibold text-black">{title}</h2>
